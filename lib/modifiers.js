...
famousCmp.ready(function(require) {
  ...
  function m(compView, method, value) {
  ...
  famousCmp.registerModifier('StateModifier', famous.modifiers.StateModifier, {
    ...
    attrUpdate: function(key, value, data, firstTime) {
      switch(key) {
        case 'transform': this.modifier.setTransform(value); break;
        case 'opacity': this.modifier.setOpacity(value); break;
//        case 'origin': this.modifier.setOrigin(value); break;
        case 'align': this.modifier.setAlign(value); break;
        case 'size': this.modifier.setSize(value); break;

        // Below are helpful shortcuts for transforms
        case 'skewX':
        case 'skewY':
          this.modifier.setTransform(Transform.multiply(
