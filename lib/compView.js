...
famousCmp.dataFromView = function(view) {
...
famousCmp.dataFromComponent = function(component) {
  log.warn("famousCmp.dataFromComponent has been deprecated.  Please use 'dataFromView' instead.");
  return famousCmp.dataFromView(component);
}
