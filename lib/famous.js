...
function famousCreated() {
  ...
  // Arrays are autodetected and specified like cellSize="[150,150]" (note the []'s)
  ...
  // Still need to autodetect strings vs numbers, etc.
  ...
  if (this.data.view != 'Surface') {
    ...
    if (node.sequenceFrom) {
      ...
      compView.sequence = compView.sequencer.child();
    }
