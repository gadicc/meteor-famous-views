...
famousCmp.famousView = Template.__create__(
  ...
  function() {        // Blaze.View "renderFunc"
    ...
    for (key in data) {
      ...
      if (view.hasRendered && value == tpl.data[key])
        continue;
      tpl.data[key] = value;
      ...
      if (compView._modifier && compView._modifier.attrUpdate)
        compView._modifier.attrUpdate.call(compView,
          key, value, data, !view.hasRendered);
      if (compView._view && compView._view.attrUpdate)
        compView._view.attrUpdate.call(compView,
          key, value, data, !view.hasRendered);
    }
