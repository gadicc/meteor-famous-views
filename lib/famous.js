...
function famousCreated() {
  ...
  compView.view = this.data.view;  // famous view TODO
  ...
  */
  ...
  if (this.data.modifier) {
    ...
    modifier = typeof modifier == 'function'
      ? new modifier(blazeView, options)
      : { famous: modifier };
  ...
  if (blazeView.templateContentBlock) {
    ...
    newBlazeView = blazeView.templateContentBlock.__makeView();
    ...
    /*
    var newBlazeView = Blaze.With(
      this.data.data || {}, // TODO, func to be reactive
      template
    );
    */
