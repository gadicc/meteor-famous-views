  ...
  eachView.stopHandle = ObserveSequence.observe(function () {
      ...
      addedAt: function (id, item, index) {
        Deps.nonreactive(function () {
          ...
          newItemView.fview = new CompView(null, {}, true);
...
function famousEachCreated() {
  ...
  var famousData = blazeView.fview = {};
  ...
  famousData.parent = parent ? parent.fview : { node: mainCtx };
...
FView.famousEachView = Template.__create__(
...
UI.registerHelper('famousEach', FView.famousEachView);
...
UI.registerHelper('famousEach', FView.Each);
*/