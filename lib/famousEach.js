function famousEachRender(eachView, template, argFunc) {
  ...
  eachView.stopHandle = ObserveSequence.observe(function () {
      ...
      addedAt: function (id, item, index) {
        var override = viewParent._view.addedAt || viewParent.addedAt;
        var _super = function() {
      ...
      removedAt: function (id, item, index) {
        var override = viewParent._view.removedAt || viewParent.removedAt;
        var _super = function() {
          Engine.defer(function() {
      ...
      changedAt: function (id, newItem, oldItem, index) {
        var override = viewParent._view.changedAt || viewParent.changedAt;
        var _super = function() {
          Engine.defer(function() {
      ...
      movedTo: function (id, doc, fromIndex, toIndex) {
        var override = viewParent._view.movedTo || viewParent.movedTo;
        var _super = function() {
          Engine.defer(function () {
