...
sequencer.prototype.lastIndex = function() {
  var lastChild;
  if (this.children.length) {
    lastChild = this.children[this.children.length-1];
    return lastChild.startIndex + lastChild.sequence.length;
  } else {
    return 0;
  }
}
sequencer.prototype.child = function() {
  var child = new childSequence(this, this.children.length, this.lastIndex());
...
childSequence.prototype.splice = function(index, howMany /*, arguments */) {
  ...
  for (var i=this.childNo; i < this.parent.children.length; i++)
