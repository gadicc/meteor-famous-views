var NodeClass = FView._classes._Node = {
  name: 'UnnamedNode',
  famousClass: null,
  ...
  newInstance: function(fview) {
    // var fview = this;
    return new this._class.famousClass();
  },
  ...
  addToParent: function() {
    // var fview = this;
    this.parent._class.addChild.call(this.parent, this.node)
  },
  ...
  addedAt: function(id, child, index) {
    // var fview = this;
    this._class.addChild.call(this, child);
  },
  ...
  dismount: function() {
    // var fview = this;
    this.parent._class.removeChild.call(this.parent, this.node);
  },
  ...
  removedAt: function(id, child, index) {
    // var fview = this;
    this._class.removeChild.call(this, child);
  },
  ...
  */
  ...
  templateCreated: function() {
    ...
    var fview = new MeteorFamousView(fviewParentFromBlazeView(blazeView),
      data.id, _class.name, parentDetails(blazeView));
    ...
    fview.node = _class.newInstance.call(fview);
    fview._class.addToParent.call(fview);
