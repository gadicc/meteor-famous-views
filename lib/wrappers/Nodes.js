...
fvNode.template = {
  ...
  onCreate: function (_class) {
    return function() {
      ...
      // Is this the best place for this? XXX
      var classes = data.class && data.class.split(" ");
      _.each(classes, function(_class) {
        _class = FView._nodeClasses[_class];
        if (_class && _class.onRender)
          _class.onRender.call(fview);
      });
    ...
    default:
      ...
      if (typeof value === 'object' && !(value instanceof Array)) {
        ...
        if (value instanceof Array)
          ...
          fview.node[method].call(fview.node, value);
      }
  }
}
