...
DOMElementView.destroyed = function() {
  // no way to remove components in famous?
  throw new Error("You tried to remove a DOMElement, but you should remove it's parent node");
};
